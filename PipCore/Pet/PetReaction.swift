...
public struct PetReaction: Sendable {
    public var first: PetMoodState
    public var second: PetMoodState
    ...
    public static func tap(on base: PetMoodState, streak tapStreak: Int) -> PetReaction {
        if tapStreak >= 6 {
